...
export class AllPromoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.get_allPromoproducts();
  }

  get_allPromoproducts() {
    this.productsService.get_allPromoProduct().subscribe(
      res => {
